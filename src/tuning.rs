...
/// Large rocks get a slight readability bump over the nominal 30-unit target.
pub const ASTEROID_LARGE_RADIUS_UNITS: f32 = 36.3;
pub const ASTEROID_LARGE_DRIFT_SPEED_SCALE: f32 = 0.5;
